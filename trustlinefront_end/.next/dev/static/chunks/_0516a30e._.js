...
function ReportsPage() {
    ...
    const loadComplaints = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('/complaints');
            setReports(data);
        ...
        "ReportsPage.useEffect": ()=>{
            ...
            if (statusFilter !== 'all') {
                filtered = filtered.filter({
                    "ReportsPage.useEffect": (r)=>r.status === statusFilter
                }["ReportsPage.useEffect"]);
            }
            // Apply search
            if (searchQuery) {
                filtered = filtered.filter({
                    "ReportsPage.useEffect": (r)=>r.case_id?.toLowerCase().includes(searchQuery.toLowerCase()) || r.category?.toLowerCase().includes(searchQuery.toLowerCase())
                }["ReportsPage.useEffect"]);
            }
...
_s(ReportsPage, "Hrx4ySHqXMAHl8YWsMfjIJu2sq4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_0516a30e._.js.map