...
function AdminReportsPage() {
    ...
    const [incidentTypeFilter, setIncidentTypeFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const loadReports = async ()=>{
        try {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/admin/complaints/queue${qs ? `?${qs}` : ''}`);
            setReports(data);
        } catch (err) {
        ...
        "AdminReportsPage.useEffect": ()=>{
            ...
            if (incidentTypeFilter !== 'all') {
                filtered = filtered.filter({
                    "AdminReportsPage.useEffect": (r)=>r.category === incidentTypeFilter
                }["AdminReportsPage.useEffect"]);
            }
            if (searchQuery) {
                filtered = filtered.filter({
                    "AdminReportsPage.useEffect": (r)=>(r.case_id || '').toLowerCase().includes(searchQuery.toLowerCase()) || (r.reporter_name || '').toLowerCase().includes(searchQuery.toLowerCase())
                }["AdminReportsPage.useEffect"]);
            }
    ...
    const handleBulkAction = async (action)=>{
        ...
        try {
            const promises = Array.from(selectedReports).map(async (reportId)=>{
                switch(action){
                    case 'assign':
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/admin/complaints/${reportId}/assign`, {
                            method: 'PATCH'
                        });
                    case 'review':
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/admin/complaints/${reportId}/status`, {
                            method: 'PATCH',
                            body: JSON.stringify({
                                status: 'under_review'
                            })
...
_s(AdminReportsPage, "SipP86G9vX3kU4Xo2+pCy9V+gyg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_5013db0a._.js.map